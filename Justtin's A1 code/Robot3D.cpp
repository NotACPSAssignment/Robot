...
void drawBody()
{
	...
	//upper body
	glPushMatrix();
	glTranslatef(0.0, 3, 0.0); // this will be done last
	glScalef(robotBodyWidth, robotBodyLength * 0.35, robotBodyDepth * 0.7);
	glutSolidCube(1.0);
	glPopMatrix();
	...
	// Bolt
	glPushMatrix();
	glTranslatef(3.3, 0.0, 0.0); // this will be done last
...
void drawLowerBody()
{
	...
	// Beam
	glPushMatrix();
	glTranslatef(3.3, 3.8, 0.0); // this will be done last
	glScalef(lowerBodyD * 0.75, lowerBodyD * 2.8, lowerBodyD * 0.8);
	glRotatef(90, 0, 1.0, 0);
	glutSolidCube(0.4);
	glPopMatrix();
	...
	glScalef(lowerBodyD, lowerBodyD, lowerBodyD);
	glRotatef(90, 0, 1.0, 0);
	gluDisk(gluNewQuadric(), 0, 0.50, 20, 10);
	glPopMatrix();
...
void drawLeftArm()
{
	...
	glTranslatef(-(0.5*robotBodyWidth + 0.5*upperArmWidth), 0.7 * upperArmLength, 0.0);
	...
	glTranslatef(0.5, -(0.5*upperArmLength + 0.5*gunLength), 0);

	// build gun
	glScalef(gunWidth, 0.75 * upperArmLength, gunDepth);
	glutSolidCube(1.0);
	glPopMatrix();
...
void drawRightArm()
{
	...
	// Position gun with respect to parent arm 
	glTranslatef(-0.5, -(0.5*upperArmLength + 0.5*gunLength), 0.0);
